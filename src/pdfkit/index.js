...
doc
  .font('Roboto')
  .text('And here is TESTESTESTE...', 100, 300)
  .fontSize(13)
  .moveDown()
  .text(lorem, {
    width: 412,
...
window.execEditor = (editorValue) => {
  var iframe = document.querySelector('iframe');
  executeFn(editorValue, PDFDocument, lorem, waitForData, iframe);
}